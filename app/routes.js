...
module.exports = function (app, passport) {
    ...
    app.use('/signu',(err,req,res,next)=>{
        res.render("layout404",{layout:"layout404"});
        next()
    })
   ...
   // LOGIN
    ...
    app.post('/updatecard/:id', permissions.can('access admin page'), upload.single('img'), (req, res) => {
        ...
        voyage.findByIdAndUpdate(req.params.id, { partenaires$set: { name: req.body.name, dateA: req.body.dateA, dateR: req.body.dateR, sejour: req.body.sejour, preview: req.body.preview, text: req.body.text, img: fileToUpload.originalname } }, { new: true }, (err, voyage) => {
